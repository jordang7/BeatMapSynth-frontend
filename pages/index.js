...
const BASE_URL = "https://beatmapsynth.com/convert"; //CHANGE THIS TO CURRENT BACKEND URL
...
export default function Home() {
  ...
  return (
    <Center height="100vh" bgColor="gray.700" bgRepeat={true}>
      <Formik
              ...
              <Field name="song" validate={validateName}>
                {({ field, form }) => (
                  ...
                  >
                    ...
                    />
                    <FormErrorMessage>{form.errors.song}</FormErrorMessage>
                  </FormControl>
                )}
              </Field>
            </Box>
            <Box m={2} p={4} bgColor="white" borderRadius={"8px"}>
              <Field name="difficulty">
                {({ field, form }) => (
                  ...
                  >
                    <FormLabel as="legend">Select Difficulty Level</FormLabel>
                    <RadioGroup {...field}>
                      <HStack spacing="24px">
